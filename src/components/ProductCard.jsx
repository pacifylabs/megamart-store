...
export default function ProductCard({ product }) {
  ...
  return (
    <div 
      ...
      className="bg-white rounded-lg border border-[#e6eef2] relative flex-shrink-0 w-[160px] sm:w-auto overflow-clip cursor-pointer hover:shadow-lg transition-shadow"
    >
